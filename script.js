...
function game(userChoice) {
  ...
  switch (userChoice + computerChoice) {
    ...
    case 'scissorspaper':
      ...
      console.log("User has picked " + userChoice + ",","Computer has picked " + computerChoice + ",","User wins.");
      break;
    case 'rockpaper':
    case 'scissorsrock':
    case 'paperscissors':
      loses(userChoice, computerChoice);
      console.log("User has picked " + userChoice + ",","Computer has picked " + computerChoice + ",","User loses.");
      break;
    case 'rockrock':
